...
function debittampil(){
    ...
    var startdebit = document.getElementById("startdebit").value; //s1.options[s.selectedIndex].value;
    var enddebit = document.getElementById("enddebit").value;
    alert(startdebit);

    firebase.database().ref('sensor/tembalang/debit').orderByChild('tanggal').startAt(startdebit).endAt(enddebit).on('value', function (snapshot) {
...
function hujantampil(){
    var starthujan = document.getElementById("starthujan").value; //s1.options[s.selectedIndex].value;
    var endhujan = document.getElementById("endhujan").value;
    console.log(starthujan+" "+endhujan);

    
    firebase.database().ref('sensor/tembalang/hujan').orderByChild('tanggal').startAt(starthujan).endAt(endhujan).on('value', function (snapshot) {
    //firebase.database().ref('sensor/tembalang/debit').once('value', function (snapshot) {
        var tblhujan = [];
        var value = snapshot.val();
        var nomer = 1;
