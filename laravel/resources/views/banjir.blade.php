...
<body>
    ...
    <script>
        ...
        // Get Data
        firebase.database().ref('Saran/').on('value', function (snapshot) {
        ...
        $('#submitUser').on('click', function () {
            ...
            firebase.database().ref('Saran/' + userID).set({
                name: name,
                email: email,
            });
        ...
        $('body').on('click', '.updateData', function () {
            ...
            firebase.database().ref('Saran/' + updateID).on('value', function (snapshot) {
        ...
        $('.updateUser').on('click', function () {
            ...
            var updates = {};
            updates['/Saran/' + updateID] = postData;
        ...
        $('.deleteRecord').on('click', function () {
            ...
            firebase.database().ref('Saran/' + id).remove();
